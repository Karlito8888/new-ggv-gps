...
const SelectScrollUpButton = React.forwardRef(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <svg className={styles.selectScrollButtonIcon} fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  >
    <span className={styles.selectItemIndicator}>
      <SelectPrimitive.ItemIndicator>
        <svg className={styles.selectItemIndicatorIcon} fill="none" stroke="currentColor" viewBox="0 0 24 24">
